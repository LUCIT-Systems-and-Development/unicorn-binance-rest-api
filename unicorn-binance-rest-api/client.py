...
class Client(object):
    ...
    def __init__(self, api_key=None, api_secret=None, requests_params=None, tld='com'):
        ...
        self.ping()
        # calculate timestamp offset between local and unicorn-binance-rest-api server
    ...
    def _init_session(self):
        ...
        session.headers.update({'Accept': 'application/json',
                                'User-Agent': 'unicorn-binance-rest-api/python',
    ...
    def universal_transfer(self, **params):
        """Unviversal transfer api accross different unicorn-binance-rest-api account types
